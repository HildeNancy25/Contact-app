...
const UpdateContact = () => {
  return (
    <section id='Update' className='flex flex-col gap-8 p-5'>
      ...
      <div className='mt-5 md:text-3xl sm:text-xl'>Updating "Uwera Anick" contact information</div>
      <div>
        <form className=' flex flex-col gap-3'>
          <label>
            Full names:
            <input className='flex border border-slate-500 text-gray-500' type='text' name='Full names' value={'Uwera Anick'}/>
          </label>
          <label>
            Email:
        ...
        <a href='/Contact'><button className='bg-yellow-500 p-2 border rounded-2xl mt-4'>Update Contact</button></a>
      </div>
    </section>
  )
}
